...
public abstract class Entity {
    ...
    public boolean isCollidingWith(Entity other){
        ...
        int leftEdge2 = other.getX();
        int rightEdge2 = other.getX()+other.getWidth();
        int topEdge2 = other.getY();
        int bottom2 = other.getY()+other.getHeight();

        if((leftEdge>rightEdge2)||(topEdge>bottom2)||(rightEdge<leftEdge2)||(bottom<topEdge2)){
            return false;
        }
        else{
        return true;
